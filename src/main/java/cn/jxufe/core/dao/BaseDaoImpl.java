...
public class BaseDaoImpl implements BaseDao {
     ...
     *
     * @param @param  object
     * @param @return 返回值类型： BeanPropertySqlParameterSource
     * @throws
     */
        ...
        jdbcTemplate.update( new PreparedStatementCreator() {
            public PreparedStatement createPreparedStatement(Connection conn) throws SQLException {
                ...
                for (int i = 0; i < args.length; i++) {
                    String a = args[i].getClass().getName();
                    if (a.equals( "java.lang.String" )) {
                        ps.setString( i + 1, (String) args[i] );
                    } else if (a.equals( "java.lang.Long" )) {
                        ps.setLong( i + 1, (Long) args[i] );
                    } else if (a.equals( "java.lang.Integer" )) {
                        ps.setInt( i + 1, (Integer) args[i] );
                    } else if (a.equals( "java.lang.Double" )) {
                        ps.setDouble( i + 1, (Double) args[i] );
                    } else if (a.equals( "java.lang.Float" )) {
                        ps.setFloat( i + 1, (Float) args[i] );
                    } else if (a.equals( "java.sql.Date" )) {
                        ps.setDate( i + 1, (Date) args[i] );
                    } else if (a.equals( "java.util.Date" )) {
                        ps.setDate( i + 1, (Date) args[i] );
                    }
                }
                return ps;
